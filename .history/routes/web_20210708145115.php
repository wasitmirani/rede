...
Route::post('/add/interest',[InterestController::class,'addInterests'])->name('my.interest');
Route::get('/my/interest',[InterestController::class,'myInterests'])->name('my.interest');
