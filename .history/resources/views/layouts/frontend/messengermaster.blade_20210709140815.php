                    ...
                    <div class="header_inner">
                        ...
                        <div class="right-side lg:pr-4">
                            ...
                            <div uk-dropdown="pos: top-right;mode:click ; animation: uk-animation-slide-bottom-small" class="header_dropdown">
                             ...
                             <!-- Notification -->
                             <a type="button" id="addPostBtn" class="bg-pink-500 flex font-bold hidden hover:bg-pink-600 hover:text-white inline-block items-center lg:block max-h-10 mr-4 px-4 py-2 rounded shado text-white" aria-expanded="false">
                                <ion-icon name="add-circle" class="-mb-1
