 ...
 <!-- Scripts
  ...
  $(document).ready(function () {
    $("#addPostBtn").on('click',function(){
       ...
       $("#postArea").html('<div class="grid grid-cols-2 gap-3 lg:p-6 p-4"><form><div class="col-span-2"><label for="about">Write Feed Here</label><textarea id="about" name="post" rows="3" class="shadow-none bg-gray-100"></textarea></div><div class="col-span-2"><button class="bg-pink-500 flex font-bold hidden hover:bg-pink-600 hover:text-white inline-block items-center lg:block max-h-10 mr-4 px-4 py-2 rounded shado text-white" aria-expanded="false" id="uploadBtn">Upload</button></div></form></div>');
