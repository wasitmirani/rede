 ...
 <!-- Scripts
  ...
  $(document).ready(function () {
    $("#addPostBtn").on('click',function(){
       ...
       $("#postArea").html('<div class="grid grid-cols-2 gap-3 lg:p-6 p-4"><div class="col-span-2"><label for="about">About me</label><textarea id="about" name="about" rows="3" class="shadow-none bg-gray-100"></textarea></div></div>');
