...
<div class="container pro-container m-auto">
    ...
    <div class="my-6 grid lg:grid-cols-5 grid-cols-3 gap-2 hover:text-yellow-700 uk-link-reset">
        <a href="#">
            <div class="bg-gray-100 border-4 border-dashed flex flex-col h-full items-center justify-center relative rounded-2xl w-full"  type="button"  data-toggle="modal" data-target="#exampleModal">
