...
<div class="container m-auto">
    ...
    <ul class="nav nav-tabs"  id="tabs-nav">
        <li  class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab1" role="tab">Profile</a></li>
        <li  class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab2" role="tab">Privacy</a></li>
