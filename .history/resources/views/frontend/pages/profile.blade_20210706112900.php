           ...
           <div class="grid grid-cols-2 gap-3 lg:p-6 p-4">
               ...
               <div>
                ...
                <div>
                    ...
                    <input type="text" placeholder="Your name.." class="shadow-none bg-gray-100" value="{{$user->username}}">
                </div>
                <div>
                 <label for="">Phone </label>
                 <input type="text" placeholder="Your name.." class="shadow-none bg-gray-100" value="{{$user->phone_number}}">
                 </div>
