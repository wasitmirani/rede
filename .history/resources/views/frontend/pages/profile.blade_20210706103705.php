...
<div class="tab-content" id="myTabContent"">
    ...
    <div class="grid lg:grid-cols-3 mt-12 gap-8 tab-pan fade show active" id="profile" role="tabpanel">
        <div>
    ...
    <div class="grid lg:grid-cols-3 mt-12 gap-8 tab-pan fade " id="privacy" role="tabpanel">
        <div>
            <h3 class="text-xl mb-2"> Basic</h3>
            <p> Lorem ipsum dolor sit amet nibh consectetuer adipiscing elit</p>
        </div>
