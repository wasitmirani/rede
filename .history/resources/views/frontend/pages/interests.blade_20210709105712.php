...
<div class="relative uk-slider" uk-slider="finite: true">
    ...
    <div class="uk-slider-container pb-3 -ml-3">
        <select class="js-example-tokenizer form-control select2-hidden-accessible" data-select2-id="select2-data-10-o7oq" tabindex="-1" aria-hidden="true" multiple="multiple">
