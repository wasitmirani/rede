...
<div class="container m-auto">
    ...
    <ul class="mt-5 -mr-3 flex-nowrap lg:overflow-hidden overflow-x-scroll uk-tab" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">  <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="home" aria-selected="true">Profile</button></li>
...
<div class="tab-content" id="myTabContent">
    ...
    <div class="grid lg:grid-cols-3 mt-12 gap-8 tab-pane fade show active" id="profile" role="tabpanel">
        <div>
    ...
    <div class="grid lg:grid-cols-3 mt-12 gap-8 tab-pane fade" id="privacy" role="tabpanel">
        <div>
            <h3 class="text-xl mb-2"> Basic</h3>
            <p> Lorem ipsum dolor sit amet nibh consectetuer adipiscing elit</p>
        </div>
