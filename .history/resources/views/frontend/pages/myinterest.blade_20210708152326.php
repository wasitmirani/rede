...
@foreach($myInterests as $myInterest)
      @foreach($myInterest->interests as $int)
            <li tabindex="-1" class="uk-active">
                ...
                <a href="#">
                    <div class="group-catagroy-card" data-src="{{asset('assets/images/product/11.jpg')}}" uk-img="" style="background-image: url(&quot;file:///C:/Users/user/Downloads/instellohtml/assets/images/product/11.jpg&quot;);">
