  ...
  <div>
   <div id="app" class="flex w-full h-screen justify-center items-center">
        <div class="w-full max-w-xl ">
            <h1 class="font-bold text-5xl text-center text-red-700">
            ...
            <div class="bg-white p-12 rounded-lg shadow-lg w-full mt-8">
                ...
                <div v-else>
                    ...
                    <div class="flex justify-start space-x-4 mt-6">
                        <p>Your Points : <span class="text-2xl text-green-700 font-bold">{{correctAnswers}}</span>
                        </p>
                    ...
                    <div class="flex">
                        <p> you are definitely ready to make some new friends and to try some new activities</p>
                    </div>
                    <div class="flex">
                        <a :href="route" class="float-right  btn btn-business">Try It Out</a>
                    </div>
