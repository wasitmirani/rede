            ...
            <div class="sidebar_inner" data-simplebar="">
                <div class="flex flex-col items-center my-6 uk-visible@s">
                    <div class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full transition m-0.5 mr-2  w-24 h-24">
                        <img src="/messenger/assets/images/avatars/avatar-2.jpg" class="bg-gray-200 border-4 border-white rounded-full w-full h-full">
                    </div>
                ...
                <div class="header_inner">
                    <div class="left-side">
                        ...
                        <div id="logo" class=" uk-hidden@s">
                            <a href="home.html">
                                <img src="/messenger/assets/images/logo-mobile.png" alt="">
                                <img src="/messenger/assets/images/logo-mobile-light.png" class="logo_inverse">
                            </a>
                        </div>
                    ...
                    <div class="right-side lg:pr-4">
                        ...
                        <a href="#">
                            <img src="/messenger/assets/images/avatars/avatar-2.jpg" class="header-avatar" alt="">
                        </a>
                ...
                <div class="lg:flex justify-center lg:space-x-10 lg:space-y-0 space-y-5">
                    ...
                    <div class="space-y-5 flex-shrink-0 lg:w-7/12">
                        ...
                        <div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0">
                            ...
                            <div uk-lightbox="">
                                <a href="/messenger/assets/images/post/img4.jpg">
                                    <img src="/messenger/assets/images/post/img4.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="py-3 px-4 space-y-3">
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="flex items-center">
                                        <img src="/messenger/assets/images/avatars/avatar-1.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900">
                                        <img src="/messenger/assets/images/avatars/avatar-4.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900 -ml-2">
                                        <img src="/messenger/assets/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900 -ml-2">
                                    </div>
                                ...
                                <div class="border-t pt-4 space-y-4 dark:border-gray-600">
                                    <div class="flex">
                                        <div class="w-10 h-10 rounded-full relative flex-shrink-0">
                                            <img src="/messenger/assets/images/avatars/avatar-1.jpg" alt="" class="absolute h-full rounded-full w-full">
                                        </div>
                        ...
                        <div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0">
                            ...
                            <div uk-lightbox="">
                                <div class="grid grid-cols-2 gap-2 p-2">
                                    ...
                                    <a href="/messenger/assets/images/post/img9.jpg" class="col-span-2">
                                        <img src="/messenger/assets/images/post/img9.jpg" alt="" class="rounded-md w-full lg:h-76 object-cover">
                                    </a>
                                    <a href="/messenger/assets/images/post/img10.jpg">
                                        <img src="/messenger/assets/images/post/img10.jpg" alt="" class="rounded-md w-full h-full">
                                    </a>
                                    <a href="/messenger/assets/images/post/img11.jpg" class="relative">
                                        <img src="/messenger/assets/images/post/img11.jpg" alt="" class="rounded-md w-full h-full">
                        ...
                        <div class="bg-white dark:bg-gray-900 shadow-md rounded-md overflow-hidden">
                            ...
                            <div class="divide-gray-300 divide-gray-50 divide-opacity-50 divide-y px-4 dark:divide-gray-800 dark:text-gray-100">
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex flex-1 items-center space-x-4">
                                        <a href="profile.html">
                                            <img src="/messenger/assets/images/avatars/avatar-2.jpg" class="bg-gray-200 rounded-full w-10 h-10">
                                        </a>
                                ...
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex flex-1 items-center space-x-4">
                                        <a href="profile.html">
                                            <img src="/messenger/assets/images/avatars/avatar-1.jpg" class="bg-gray-200 rounded-full w-10 h-10">
                                        </a>
                                        <div class="flex flex-col">
                                ...
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex flex-1 items-center space-x-4">
                                        <a href="profile.html">
                                            <img src="/messenger/assets/images/avatars/avatar-5.jpg" class="bg-gray-200 rounded-full w-10 h-10">
                                        </a>
                                        <div class="flex flex-col">
                                ...
                                <div class="flex items-center justify-between py-3">
                                    <div class="flex flex-1 items-center space-x-4">
                                        <a href="profile.html">
                                            <img src="/messenger/assets/images/avatars/avatar-7.jpg" class="bg-gray-200 rounded-full w-10 h-10">
                                        </a>
                                        <div class="flex flex-col">
                                ...
                                <div class="grid grid-cols-2 gap-2 p-3 uk-link-reset">
                                    ...
                                    <div class="bg-red-500 max-w-full h-32 rounded-lg relative overflow-hidden uk-transition-toggle">
                                        <a href="#story-modal" uk-toggle="">
                                            <img src="/messenger/assets/images/post/img2.jpg" class="w-full h-full absolute object-cover inset-0">
                                        </a>
                                    ...
                                    <div class="bg-red-500 max-w-full h-40 rounded-lg relative overflow-hidden uk-transition-toggle">
                                        <a href="#story-modal" uk-toggle="">
                                            <img src="/messenger/assets/images/post/img7.jpg" class="w-full h-full absolute object-cover inset-0">
                                        </a>
                                        <div class="flex flex-1 justify-around items-center absolute bottom-0 w-full p-2 text-white custom-overly1 uk-transition-slide-bottom-medium">
                                            <a href="#"> <i class="uil-heart"></i> 150 </a>
                                            <a href="#"> <i class="uil-heart"></i> 30 </a>
                                    ...
                                    <div class="bg-red-500 max-w-full h-40 -mt-8 rounded-lg relative overflow-hidden uk-transition-toggle">
                                        <a href="#story-modal" uk-toggle="">
                                            <img src="/messenger/assets/images/post/img5.jpg" class="w-full h-full absolute object-cover inset-0">
                                        </a>
                                        <div class="flex flex-1 justify-around  items-center absolute bottom-0 w-full p-2 text-white custom-overly1 uk-transition-slide-bottom-medium">
                                            <a href="#"> <i class="uil-heart"></i> 150 </a>
                                            <a href="#"> <i class="uil-heart"></i> 30 </a>
                                    ...
                                    <div class="bg-red-500 max-w-full h-32 rounded-lg relative overflow-hidden uk-transition-toggle">
                                        <a href="#story-modal" uk-toggle="">
                                            <img src="/messenger/assets/images/post/img3.jpg" class="w-full h-full absolute object-cover inset-0">
                                        </a>
                                        <div class="flex flex-1 justify-around  items-center absolute bottom-0 w-full p-2 text-white custom-overly1 uk-transition-slide-bottom-medium">
                                            <a href="#"> <i class="uil-heart"></i> 150 </a>
                                            <a href="#"> <i class="uil-heart"></i> 30 </a>
