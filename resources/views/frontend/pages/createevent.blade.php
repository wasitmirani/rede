...
@section('content')
<h1 class="lg:text-2xl text-lg font-extrabold leading-none text-gray-900 tracking-tight mb-2">Create Happening</h1>
<div>
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-12 sm:col-span-12">
                  <label for="first-name" class="block text-sm font-medium text-gray-700">Happening Title</label>
                ...
                <div class="col-span-12 sm:col-span-12">
                  <label for="last-name" class="block text-sm font-medium text-gray-700">Happening Type</label>
                    @if($errors->has('type'))
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    @endif
                    <label for="street-address" class="block text-sm font-medium text-gray-700">Happening McGuffins</label>
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    @endif
                    <label for="country" class="block text-sm font-medium text-gray-700">Attendance</label>
                        <label class="inline-flex items-center">
