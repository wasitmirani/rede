        ...
        <div class="lg:w/8/12 flex-1 flex flex-col lg:items-start items-center">
            ...
            <div class="capitalize flex font-semibold space-x-3 text-center text-sm my-2">
                ...
                <div>
                    ...
                    <div class="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden text-base dark:bg-gray-900 uk-drop"
                        uk-drop="mode: click">
            ...
            <div
                ...
                <div class="flex lg:flex-row flex-col"> {{ $user->profile->covid_status }}<strong
                        class="lg:pl-2"></strong></div>
                <div class="lg:pl-4 flex lg:flex-row flex-col"> {{ $user->profile->age }} <strong
                        class="lg:pl-2"></strong></div>
                <div class="lg:pl-4 flex lg:flex-row flex-col"> {{ $user->profile->pronouns }} <strong
                        class="lg:pl-2"></strong></div>
            </div>
        </div>
        <div class="w-20"></div>
    ...
    @foreach ($particulars as $particular)
        ...
        <div class="relative uk-visible@s uk-slider" uk-slider="finite: true">
            ...
            <a class="-left-2 absolute bg-white bottom-1/2 flex items-center justify-center p-2 rounded-full shadow text-xl w-9 z-10 dark:bg-gray-800 dark:text-white"
                href="#"> <i class="icon-feather-chevron-left"></i> </a>
            <a class="absolute bg-white bottom-1/2 flex items-center justify-center p-2 right-4 rounded-full shadow text-xl w-9 z-10 dark:bg-gray-800 dark:text-white uk-invisible"
                        ...
                        <li tabindex="-1" class="">
                            <a href="#">
                                <div
                                    ...
                                    <img src="{{ asset('user/particular/images/' . $detail->image) }}"
