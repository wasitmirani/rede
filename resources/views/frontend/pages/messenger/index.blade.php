                    ...
                    <form method="post" action="{{ route('my.story') }}">
                        ...
                        <div class="col-span-2 m-4	">
                            <div class="grid grid-cols-3 gap-4">
                                <button type="submit"
                                    class="bg-blue-500 flex font-bold hidden hover:bg--600 hover:text-white inline-block items-center lg:block max-h-10 mr-4 px-4 py-2 rounded shado text-white"
                                    aria-expanded="false" id="uploadBtn">Update Story</button>
                            </div>
                        </div>
                    ...
                    <form id="postForm" method="post">
                        ...
                        <div class="col-span-2 m-4	">
                            <div class="grid grid-cols-3 gap-4">
                                <button type="submit"
                                    class="bg-blue-500 flex font-bold hidden hover:bg--600 hover:text-white inline-block items-center lg:block max-h-10 mr-4 px-4 py-2 rounded shado text-white"
                                    aria-expanded="false" id="uploadBtn">Post</button>
            ...
            $('#postForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(msg) {
                        var output = '';
                        output +=
                            '<div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0"><div class="flex justify-between items-center px-4 py-3">' +
                            '<div class="flex flex-1 items-center space-x-4">' +
                            '<a href="#">' +
                            '<div class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-0.5 rounded-full">' +
                            '<img src="{{ asset('user/images/') }}/' + msg.image +
                            ...
                            '<img src="{{ asset('/user/post/images/') }}/' + msg.image +
                            '" alt="" style="width:665px;">' +
            ...
            $('.commentForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    succss: function(msg) {
                        ...
                        output +=
                            '<div class="flex"><div class="w-10 h-10 rounded-full relative flex-shrink-0 ml-4 mb-4">' +
                ...
                $.ajax({
                    ...
                    success: function(msg) {
                        ...
                        jQuery.each(msg, function(index, item) {
                            ...
                            output +=
                                '<div class="flex"><div class="w-10 h-10 rounded-full relative flex-shrink-0 ml-4 mb-4">' +
                                '<img src="{{ asset('user/images/') }}/' + item.user
                                .image +
                                '" alt="" class="absolute h-full rounded-full w-full">' +
                                '</div>' +
                                '<div class="text-gray-700 py-2 px-3 rounded-md bg-gray-100 h-full relative lg:ml-5 ml-2 lg:mr-20  dark:bg-gray-800 dark:text-gray-100">' +
                                '<p class="leading-6" >' + item.comment +
