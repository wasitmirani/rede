...
var example1 = document.getElementById('example1'),
    ...
    swapDemo = document.getElementById('swapDemo'); // Example 1 - Simple list
...
function renderThresholdWidth(evt) {
  ...
  for (var i = 0; i < activeIndicators.length; i++) {
    activeIndicators[i].style[example7SizeProperty] = evt.target.value * 100 / (activeIndicators == example7SwapThresholdIndicators ? 1 : 2) + '%';
  }
